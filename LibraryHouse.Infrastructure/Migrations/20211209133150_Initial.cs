        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankAccount = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCompanies", x => new { x.BookId, x.CompanyId });
                    table.ForeignKey(
                        name: "FK_BookCompanies_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCompanies_Companies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCompanies_BookId_CompanyId",
                table: "BookCompanies",
                columns: new[] { "BookId", "CompanyId" });
